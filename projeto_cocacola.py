...
RADAR_CONFIGS = [
    {
        ...
        'spreadsheet_name': 'Projeto_cocacola_radar1',  # Nome correto da planilha do RADAR_1
    ...
    },
    {
        ...
        'spreadsheet_name': 'Projeto_cocacola_radar2',  # Nome correto da planilha do RADAR_2
        'worksheet_name': 'Página1'  # Nome correto da worksheet
    }
]
